...
class Workout(models.Model):
    ...
    difficulty = models.CharField(verbose_name='Сложность', max_length = 255)
    ...
    gender=models.CharField(verbose_name='Пол', max_length = 255)
    inventory = models.CharField(verbose_name='Инвентарь', max_length = 255)
